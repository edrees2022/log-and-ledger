...
function Sidebar({
  ...
  // Determine physical side based on direction
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed top-[7rem] bottom-14 md:bottom-24 z-10 hidden w-[var(--sidebar-width)] transition-[left,right,width] duration-200 ease-linear md:flex",
          physicalSide === "left"
